...
const Navbar = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      ...
      <div className={`lg:hidden md:hidden ${showMobileMenu ? 'fixed w-full' :'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
        <div className='flex justify-end p-6 cursor-pointer'>
          <IoClose className='text-3xl' onClick={()=>setShowMobileMenu(false)}/>
        </div>
